    ...
    <Container>
        <Row className="mb-4">
            ...
            <div className="form-group">
                <Input type="email" name="email" onChange={(data) => setEmail(data)} className="form-control" placeholder="Email..." />
                <Button type="button" onClick={sendInvite} className="btn"><span className="fa fa-paper-plane"></span></Button>
            </div>
            </Form>
            </Col>
        </Row>
